<nav id="menu">
				<ul>
					...
					<ul id="lienAumonerie" class="blocLienMenu puceSecondaires">
						...
						<li class="lienMenu"><a href="accueil">C'est o�  ma maison ?</a></li>
					...
					<ul id="lienActivite" class="blocLienMenu puceSecondaires">
						...
						<li class="lienMenu"><a href="accueil">Les grands évenements</a></li>
					...
					<ul id="lienAntenne" class="blocLienMenu puceSecondaires">
						<li class="lienMenu"><a href="accueil">Ingénieur</a></li>
						<li class="lienMenu"><a href="accueil">Commerce</a></li>
						<li class="lienMenu"><a href="accueil">Santé</a></li>
