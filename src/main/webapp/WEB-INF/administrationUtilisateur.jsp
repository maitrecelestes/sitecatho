...
<link rel="stylesheet" type="text/css"
	href="css/administrationUtilisateur.css" />
		...
		<section id="blocDroitPrincipalPage">
			...
			<div id="blocArticle">
				...
				<table id="tabListeUtilisateur">
					...
					<c:forEach var="listeUtilisateur"
						items="${listeMessageUtilisateur}">
						<tr>
				...
				<input type="button" class="bouttonAdm" value="Creer un utilisateur"
					id="montrerFormCreationUtilisateur" />
				<div id="ajoutUtilisateur">
					<h3>Creer un nouvel utilisateur</h3>
					<table>
						<tr>
							<td><label for="newMail">Mail :</label></td>
							<td><input type="email" id="newMail" /><br /></td>
							<td>Sous la forme : --@--.--<br /></td>
						</tr>
						<tr>
							<td><label for="newNom">Nom :</label></td>
							<td><input type="text" id="newNom" /><br /></td>
							<td>(obligatoire)<br /></td>
						</tr>
						<tr>
							<td><label for="newPrenom">Prenom :</label></td>
							<td><input type="text" id="newPrenom" /><br /></td>
							<td>(obligatoire)<br /></td>
						</tr>
						<tr>
							<td><label for="newMdp">Mot de passe :</label></td>
							<td><input type="password" id="newMdp" /><br /></td>

							<td>(4 caractères minimum)<br /></td>
						</tr>
						<tr>
							<td><label for="newConfMdp"> Retapez le mot de passe
									:</label></td>
							<td><input type="password" id="newConfMdp" /><br /></td>
						</tr>
						<tr>
							<td><label for="newRang">Rang :</label></td>
							<td><select id="newRang"><option
										id="administrateur">administrateur</option>
									<option id="redacteur" selected>redacteur</option></select><br /></td>
						</tr>
						<tr id="pageGeretr">
							<td><label for="pageGere">Page gérée :</label></td>
						...
						<tr>
							<td><label for="newEcole">Ecole :</label></td>
							<td><input type="text" id="newEcole" /><br /></td>
							<td>(obligatoire)<br /></td>
						</tr>
						<tr>
							<td colspan="2" id="caseajouterUtilisateur"><input
								type="button" class="bouttonAdm" value="Ajouter cet utilisateur" /></td>
						</tr>
					</table>
				</div>
				<div id="modifierUtilisateur">
					...
					<table>
						<tr>
							<td><label for="modMail">Mail :</label></td>
							<td id="modMail"></td>
						</tr>
						<tr>
							<td><label for="modRang">Rang :</label></td>
							<td><select id="modRang"><option
						...
						<tr id="modpageGeretr">
							...
							<td><select name="modPageGere" id="modPageGere">
									<c:forEach var="modPageGere" items="${listeMenu}">
										<option id="modPageGere${modPageGere.idpage}"
											value="${modPageGere.nompage}" ${modPageGere.idpage}>${modPageGere.nompage}</option>
									</c:forEach>
							</select></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" id="modEcole" /><br /></td>
						</tr>
						<tr>
							<td colspan="2" id="casemodifierUtilisateur"><input
								type="button" class="bouttonAdm"
								value="Enregistrer les modifications" /></td>
						</tr>
					</table>
				</div>
