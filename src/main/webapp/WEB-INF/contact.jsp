	...
	<section id="blocPrincipalPage">
		...
		<section id="blocDroitPrincipalPage">
			...
			<div id="blocArticle">
				...
				<p>Vous pouvez poster ici un message à l'attention de
					l'aumônerie. Ce message sera lu par les responsables qui vous
					recontacterons si besoin.</p>
				<form>
					<table>
						<tr>
						...
						<tr>
							...
							<td><span class="renseignement">Sous la forme :
									--@--.--</span><br /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><textarea id="contenu"></textarea></td>
						</tr>
						<tr>
							<td colspan="2"><input id="envoyer" class="bouttonAdm"
								type="button" value="Envoyer le message" width="100px;"></td>
						</tr>
					</table>
				</form>
			</div>
